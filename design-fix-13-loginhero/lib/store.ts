...
export interface Kurs {
  ...
  isCustom?: boolean;
  /** Kursdeltagare — elever direkt på kursen utan klasskrav (t.ex. högskola). */
  students: Student[];
}
...
// ============================================================================
// KURSKATALOG - Statisk referenslista (Skolverkets GY11-nomenklatur).
// Används ENDAST som uppslag/valförslag — renderas aldrig som lärarens kurser.
// ============================================================================

export const KURSKATALOG: Kurs[] = [
  // Matematik
  { id: "matte1c", name: "Matematik 1c", code: "MATMAT01c", subject: "Matematik", level: "Gymnasiet", description: "Gymnasiematematik med algebra, funktioner och statistik.", gradeThresholds: DEFAULT_GRADE_THRESHOLDS, students: [] },
  { id: "matte1b", name: "Matematik 1b", code: "MATMAT01b", subject: "Matematik", level: "Gymnasiet", description: "Matematik för samhälls- och ekonomiprogrammen.", gradeThresholds: DEFAULT_GRADE_THRESHOLDS, students: [] },
  { id: "matte1a", name: "Matematik 1a", code: "MATMAT01a", subject: "Matematik", level: "Gymnasiet", description: "Matematik för estetiska och humanistiska program.", gradeThresholds: DEFAULT_GRADE_THRESHOLDS, students: [] },
  { id: "matte2", name: "Matematik 2a/2b/2c", code: "MATMAT02", subject: "Matematik", level: "Gymnasiet", description: "Fortsättningskurs i matematik.", gradeThresholds: DEFAULT_GRADE_THRESHOLDS, students: [] },
  { id: "matte3", name: "Matematik 3b/3c", code: "MATMAT03", subject: "Matematik", level: "Gymnasiet", description: "Funktioner, derivata, integraler och sannolikhet.", gradeThresholds: DEFAULT_GRADE_THRESHOLDS, students: [] },
  { id: "matte4", name: "Matematik 4", code: "MATMAT04", subject: "Matematik", level: "Gymnasiet", description: "Avancerad matematik med komplexa tal, differentialekvationer och linjär algebra.", gradeThresholds: DEFAULT_GRADE_THRESHOLDS, students: [] },
  { id: "matte5", name: "Matematik 5", code: "MATMAT05", subject: "Matematik", level: "Gymnasiet", description: "Fördjupning i matematisk analys.", gradeThresholds: DEFAULT_GRADE_THRESHOLDS, students: [] },
  { id: "matte-spec", name: "Matematik – specialisering", code: "MATMAT00", subject: "Matematik", level: "Gymnasiet", description: "Fördjupningskurs inom ett valt matematiskt område.", gradeThresholds: DEFAULT_GRADE_THRESHOLDS, students: [] },
  // Naturvetenskap
  { id: "fysik1", name: "Fysik 1", code: "FYSFYS01", subject: "Fysik", level: "Gymnasiet", description: "Mekanik, värme, vågor och ellära.", gradeThresholds: DEFAULT_GRADE_THRESHOLDS, students: [] },
  { id: "fysik2", name: "Fysik 2", code: "FYSFYS02", subject: "Fysik", level: "Gymnasiet", description: "Fördjupningskurs i fysik med mekanik, svängningar, vågrörelser och modern fysik.", gradeThresholds: DEFAULT_GRADE_THRESHOLDS, students: [] },
  { id: "kemi1", name: "Kemi 1", code: "KEMKEM01", subject: "Kemi", level: "Gymnasiet", description: "Grundläggande kemi med atom- och molekyllära.", gradeThresholds: DEFAULT_GRADE_THRESHOLDS, students: [] },
  { id: "kemi2", name: "Kemi 2", code: "KEMKEM02", subject: "Kemi", level: "Gymnasiet", description: "Fördjupning i organisk kemi, reaktionskinetik och kemisk jämvikt.", gradeThresholds: DEFAULT_GRADE_THRESHOLDS, students: [] },
  { id: "biologi1", name: "Biologi 1", code: "BIOBIO01", subject: "Biologi", level: "Gymnasiet", description: "Cell, genetik och ekologi.", gradeThresholds: DEFAULT_GRADE_THRESHOLDS, students: [] },
  { id: "biologi2", name: "Biologi 2", code: "BIOBIO02", subject: "Biologi", level: "Gymnasiet", description: "Fysiologi, evolution och bioteknik.", gradeThresholds: DEFAULT_GRADE_THRESHOLDS, students: [] },
  { id: "natkunskap1a", name: "Naturkunskap 1a", code: "NARNAT01a", subject: "Naturkunskap", level: "Gymnasiet", description: "Tvärvetenskaplig naturvetenskap för samhällsprogram.", gradeThresholds: DEFAULT_GRADE_THRESHOLDS, students: [] },
  { id: "natkunskap1b", name: "Naturkunskap 1b", code: "NARNAT01b", subject: "Naturkunskap", level: "Gymnasiet", description: "Fortsättningskurs i naturvetenskap.", gradeThresholds: DEFAULT_GRADE_THRESHOLDS, students: [] },
  // Teknik & data
  { id: "teknik1", name: "Teknik 1", code: "TEKTEK01", subject: "Teknik", level: "Gymnasiet", description: "Tekniska system, konstruktion och hållbar utveckling.", gradeThresholds: DEFAULT_GRADE_THRESHOLDS, students: [] },
  { id: "teknik2", name: "Teknik 2", code: "TEKTEK02", subject: "Teknik", level: "Gymnasiet", description: "Fördjupning inom teknik och design.", gradeThresholds: DEFAULT_GRADE_THRESHOLDS, students: [] },
  { id: "teknik3", name: "Teknik 3", code: "TEKTEK03", subject: "Teknik", level: "Gymnasiet", description: "Avancerad teknik och produktutveckling.", gradeThresholds: DEFAULT_GRADE_THRESHOLDS, students: [] },
  { id: "teknik4", name: "Teknik 4", code: "TEKTEK04", subject: "Teknik", level: "Gymnasiet", description: "Specialiserad teknikkurs.", gradeThresholds: DEFAULT_GRADE_THRESHOLDS, students: [] },
  { id: "prog1", name: "Programmering 1", code: "PRRPRR01", subject: "Programmering", level: "Gymnasiet", description: "Grundläggande programmering med Python, algoritmer och datastrukturer.", gradeThresholds: DEFAULT_GRADE_THRESHOLDS, students: [] },
  { id: "prog2", name: "Programmering 2", code: "PRRPRR02", subject: "Programmering", level: "Gymnasiet", description: "Fördjupning i programmering och mjukvaruutveckling.", gradeThresholds: DEFAULT_GRADE_THRESHOLDS, students: [] },
  { id: "tillampad-prog", name: "Tillämpad programmering", code: "PRRAPP01", subject: "Programmering", level: "Gymnasiet", description: "Programmering i ett tillämpat projekt.", gradeThresholds: DEFAULT_GRADE_THRESHOLDS, students: [] },
  { id: "webbutv1", name: "Webbutveckling 1", code: "GRNWEB01", subject: "Programmering", level: "Gymnasiet", description: "Webbteknik, HTML, CSS och grundläggande JavaScript.", gradeThresholds: DEFAULT_GRADE_THRESHOLDS, students: [] },
  { id: "webbutv2", name: "Webbutveckling 2", code: "GRNWEB02", subject: "Programmering", level: "Gymnasiet", description: "Fördjupning inom webbutveckling.", gradeThresholds: DEFAULT_GRADE_THRESHOLDS, students: [] },
  { id: "datorteknik1", name: "Datorteknik 1", code: "DAODAT01", subject: "Teknik", level: "Gymnasiet", description: "Datorns uppbyggnad, nätverk och operativsystem.", gradeThresholds: DEFAULT_GRADE_THRESHOLDS, students: [] },
  // Högstadiet
  { id: "matte-ak7", name: "Matematik (åk 7–9)", code: "MAT", subject: "Matematik", level: "Högstadiet", description: "Högstadiematematik.", gradeThresholds: DEFAULT_GRADE_THRESHOLDS, students: [] },
  { id: "fysik-ak7", name: "Fysik (åk 7–9)", code: "FYS", subject: "Fysik", level: "Högstadiet", description: "Högstadietfysik.", gradeThresholds: DEFAULT_GRADE_THRESHOLDS, students: [] },
  { id: "kemi-ak7", name: "Kemi (åk 7–9)", code: "KEM", subject: "Kemi", level: "Högstadiet", description: "Högstadietkemi.", gradeThresholds: DEFAULT_GRADE_THRESHOLDS, students: [] },
  { id: "biologi-ak7", name: "Biologi (åk 7–9)", code: "BIO", subject: "Biologi", level: "Högstadiet", description: "Högstadietbiologi.", gradeThresholds: DEFAULT_GRADE_THRESHOLDS, students: [] },
  { id: "teknik-ak7", name: "Teknik (åk 7–9)", code: "TEK", subject: "Teknik", level: "Högstadiet", description: "Högstadietteknik.", gradeThresholds: DEFAULT_GRADE_THRESHOLDS, students: [] },
];
...
export const useStore = create<StoreState>(() => ({
  // Endast lärarens egna backend-kurser. KURSKATALOG är en separat
  // referenslista och får aldrig in i detta state.
  kurser: [],
  klasser: [],
  prov: [],
  results: [],
...
/** Slår upp ett kurs-id: lärarens egna kurser först, katalogen som fallback
 *  (gamla klasser kan peka på katalog-id:n som "matte1c"). */
export function resolveKurs(kurser: Kurs[], kursId: string | undefined): Kurs | undefined {
  if (!kursId) return undefined;
  return kurser.find((k) => k.id === kursId) ?? KURSKATALOG.find((k) => k.id === kursId);
}
...
export const actions = {
  ...
  deleteKurs: async (kursId: string): Promise<void> => {
    ...
    useStore.setState((state) => {
      const testIds = new Set(state.prov.filter((p) => p.kursId === kursId).map((p) => p.id));
      return {
        kurser: state.kurser.filter((k) => k.id !== kursId),
        prov: state.prov.filter((p) => p.kursId !== kursId),
        results: state.results.filter((r) => !testIds.has(r.provId)),
      };
    });
  },

  loadKurs: async (kursId: string): Promise<Kurs> => {
    const kurs = mapBackendCourse(await api.getCourse(kursId));
    useStore.setState((state) => ({
      kurser: state.kurser.some((k) => k.id === kurs.id)
        ? state.kurser.map((k) => (k.id === kurs.id ? kurs : k))
        : [...state.kurser, kurs],
    }));
    return kurs;
  },

  addCourseStudent: async (kursId: string, data: { name: string; identifier?: string }): Promise<Student> => {
    const s = await api.addCourseStudent(kursId, data);
    const student: Student = { id: s.id, name: s.name, identifier: s.identifier ?? undefined };
    useStore.setState((state) => ({
      kurser: state.kurser.map((k) =>
        k.id === kursId ? { ...k, students: [...k.students, student] } : k,
      ),
    }));
    return student;
  },

  deleteCourseStudent: async (kursId: string, studentId: string): Promise<void> => {
    await api.deleteCourseStudent(kursId, studentId);
    useStore.setState((state) => ({
      kurser: state.kurser.map((k) =>
        k.id === kursId ? { ...k, students: k.students.filter((s) => s.id !== studentId) } : k,
      ),
    }));
  },
  ...
  startProv: async (data: {
    /** Klassprov: klassId. Kursprov (utan klass): kursId. Exakt ett krävs. */
    klassId?: string;
    kursId?: string;
    title: string;
    date: string;
    ...
    const backendTest = data.kursId
      ? await api.createCourseTest(data.kursId, payload)
      : await api.createTest(data.klassId!, payload);
