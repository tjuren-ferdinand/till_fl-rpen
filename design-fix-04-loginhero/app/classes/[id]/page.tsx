...
import { useStore, actions, resolveKurs, type Prov, type StudentResult, type GradingParams } from "@/lib/store";
...
export default function ClassPage() {
  ...
  const kursName = resolveKurs(kurser, klass.kursId)?.name || klass.kursId || "Kurs";
