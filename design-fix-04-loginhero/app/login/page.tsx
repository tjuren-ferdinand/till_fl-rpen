  ...
  return (
    ...
    >
      ...
      <motion.img
        ...
        src="/hero/bg-exams-hero.jpg"
        alt=""
        aria-hidden="true"
        className="absolute inset-0 hidden h-full w-full object-cover object-[62%_50%] md:block"
      />
      ...
      <motion.img
        ...
        src="/hero/bg-exams-hero.jpg"
        alt="Handskrivna prov i matte, fysik och kemi runt en laptop med WiseOS översikt"
