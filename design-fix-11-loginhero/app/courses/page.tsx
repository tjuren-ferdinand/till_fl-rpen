...
export default function CoursesPage() {
  ...
  return (
    <div className="space-y-10">
      ...
      {!creating && sortedGroups.length === 0 && (
        <div className="rounded-2xl border border-ink-hairline/10 bg-paper-raised p-10 text-center shadow-soft">
          ...
          <h2 className="mt-4 text-[17px] font-medium tracking-[-0.01em] text-ink">
            Inga kurser ännu
          </h2>
          <p className="mx-auto mt-2 max-w-sm text-[13.5px] leading-relaxed text-ink-secondary">
            Kurser samlar dina klasser, elever och prov. Skapa din första kurs
            för att komma igång med rättningen.
          </p>
          <button
            type="button"
