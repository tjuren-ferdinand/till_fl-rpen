  ...
  return (
    ...
    >
      ...
      <motion.img
        ...
        src="/hero/bg-tablet-hero.jpg"
        alt=""
        aria-hidden="true"
        className="absolute inset-0 hidden h-full w-full object-cover object-[68%_50%] md:block"
      />
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 md:flex md:min-h-screen md:items-center">
        <div className="max-w-xl md:-translate-y-5">
          ...
          <motion.p
            ...
            className="mt-8 text-[17px] font-normal leading-relaxed text-ink"
          >
            AI som rättar. Du som bestämmer.
          </motion.p>
          ...
          <motion.p
            ...
            className="mt-10 flex items-center gap-3 text-[12px] font-medium uppercase tracking-[0.14em] text-ink-muted"
          >
            <span className="h-px w-8 bg-ink-hairline/40" aria-hidden="true" />
      ...
      <motion.img
        ...
        src="/hero/bg-tablet-hero.jpg"
        alt="Surfplatta som visar WiseOS översikt"
