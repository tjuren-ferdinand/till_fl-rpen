  ...
  return (
    ...
    >
      ...
      <div className="relative hidden md:block">
        ...
        {/* Texten i glappet: glappet ligger x≈14–36%, y≈30–63% i bilden */}
        <div className="absolute left-[15%] top-[37%] w-[23%]">
          <motion.h1
            initial={{ opacity: 0, y: 20 }}
            animate={isInView ? { opacity: 1, y: 0 } : {}}
            transition={{ duration: 0.7, delay: 0.05, ease: [0.22, 1, 0.36, 1] }}
            className="text-[clamp(28px,2.6vw,40px)] font-medium leading-[1.05] tracking-[-0.03em] text-ink"
          >
            Rätta<br />smartare.
          </motion.h1>
          <motion.p
            ...
            className="mt-4 text-[clamp(14px,1.2vw,18px)] font-light leading-[1.3] tracking-[-0.01em] text-ink-secondary"
          >
