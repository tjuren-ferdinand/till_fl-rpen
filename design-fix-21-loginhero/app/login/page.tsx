  ...
  return (
    ...
    >
      ...
      <div className="relative hidden md:block">
        ...
        {/* Texten i glappet: den tomma vänsterkolumnen x≈1–19%, y≈25–75% */}
        <div className="absolute left-[3%] top-[40%] w-[16%]">
          <motion.h1
            initial={{ opacity: 0, y: 20 }}
            animate={isInView ? { opacity: 1, y: 0 } : {}}
            transition={{ duration: 0.7, delay: 0.05, ease: [0.22, 1, 0.36, 1] }}
            className="text-[clamp(22px,2.1vw,32px)] font-medium leading-[1.05] tracking-[-0.03em] text-ink"
          >
            Rätta<br />smartare.
          </motion.h1>
          <motion.p
            ...
            className="mt-4 text-[clamp(13px,1.05vw,16px)] font-light leading-[1.3] tracking-[-0.01em] text-ink-secondary"
          >
