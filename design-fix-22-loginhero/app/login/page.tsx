  ...
  return (
    <motion.header
      ...
      className={`fixed inset-x-0 top-0 z-50 h-16 transition-all duration-300 ${
        scrolled
          ? "border-b border-ink-hairline/5 bg-paper/80 shadow-soft backdrop-blur-xl"
...
function Hero({ openAuth }: { openAuth: (mode: AuthMode) => void }) {
  ...
  return (
    <section
      ref={ref}
      className="relative overflow-hidden bg-paper pt-28 md:pt-0"
    >
      {/* Desktop: bilden i naturligt format — wrappern har exakt bildens mått,
          så textens procent-positioner är bildkoordinater och låser mot glappet */}
      <div className="relative hidden md:block">
        <motion.img
          initial={{ opacity: 0 }}
          animate={isInView ? { opacity: 1 } : {}}
          transition={{ duration: 1.2, ease: [0.22, 1, 0.36, 1] }}
          src="/hero/bg-pool22-hero.jpg"
          alt="Handskrivna rättade prov runt en laptop som visar WiseOS översikt"
          className="block h-auto w-full"
        />
        {/* Svag slöja — läsbarhet utan att radera glappets papperkanter */}
        <div className="absolute inset-0 bg-gradient-to-r from-paper/60 via-paper/15 to-transparent" />
        {/* Texten i glappet: den stora tomma cream-ytan uppe till vänster, x≈2–45%, y≈5–45% */}
        <div className="absolute left-[8%] top-[16%] w-[30%]">
          <motion.h1
            initial={{ opacity: 0, y: 20 }}
            animate={isInView ? { opacity: 1, y: 0 } : {}}
            transition={{ duration: 0.7, delay: 0.05, ease: [0.22, 1, 0.36, 1] }}
            className="text-[clamp(30px,3vw,46px)] font-medium leading-[1.05] tracking-[-0.03em] text-ink"
          >
            Rätta<br />smartare.
          </motion.h1>
          <motion.p
            ...
            className="mt-4 text-[clamp(15px,1.3vw,19px)] font-light leading-[1.3] tracking-[-0.01em] text-ink-secondary"
          >
      ...
      {/* Mobil: text först, bilden som band under */}
      <div className="relative z-10 px-6 md:hidden">
        <motion.h1
          initial={{ opacity: 0, y: 20 }}
          animate={isInView ? { opacity: 1, y: 0 } : {}}
          transition={{ duration: 0.7, delay: 0.05, ease: [0.22, 1, 0.36, 1] }}
          className="text-[34px] font-medium leading-[1.05] tracking-[-0.03em] text-ink"
        >
          Rätta smartare.
        </motion.h1>
        <motion.p
          ...
          animate={isInView ? { opacity: 1, y: 0 } : {}}
          transition={{ duration: 0.7, delay: 0.15, ease: [0.22, 1, 0.36, 1] }}
          className="mt-3 text-[17px] font-light leading-[1.3] tracking-[-0.01em] text-ink-secondary"
        >
          Lägg tiden på eleverna.
        </motion.p>
      </div>
    ...
    <Section className="bg-paper-raised">
      <div className="mx-auto max-w-4xl px-6 text-center">
        <motion.h2
          ...
          className="text-[36px] font-medium leading-[1.08] tracking-[-0.03em] text-ink md:text-[56px]"
        >
          Söndag är inte till för 60 prov.
        </motion.h2>
        <motion.p
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.7, delay: 0.15, ease: [0.22, 1, 0.36, 1] }}
          className="mx-auto mt-8 max-w-xl text-[17px] leading-relaxed text-ink-secondary"
        >
          Varje lösning måste förstås. Inte bara svaret.
          <br />
          Lita på AI:n. Ändå bestämma själv.
        </motion.p>
      </div>
    </Section>
  );
...
function Contrast() {
  ...
  const newWay = ["Ladda upp", "Förstå", "Bedöm", "Granska"];

  return (
    <Section>
      <div className="mx-auto max-w-5xl px-6">
        <Eyebrow>Skillnaden</Eyebrow>
        <div className="mt-12 grid gap-14 md:grid-cols-2 md:gap-20">
          ...
          >
            ...
            <p className="mt-5 text-[15px] leading-[2.4] text-ink-muted">
              {oldWay.join(" → ")}
            </p>
            <p className="mt-5 text-[13px] text-ink-muted">
              7 steg. Varje prov. Varje gång.
            </p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 16 }}
          ...
          >
            <p className="text-[12px] font-medium uppercase tracking-[0.14em] text-ink">
              Nu
            </p>
            <p className="mt-5 text-[15px] font-medium leading-[2.4] text-ink">
              {newWay.join(" → ")}
            </p>
            <p className="mt-5 text-[13px] text-ink-secondary">
              Du kontrollerar. Du godkänner.
            </p>
          </motion.div>
        </div>
        <motion.p
          ...
          className="mt-16 text-center text-[20px] font-light tracking-[-0.01em] text-ink-secondary md:text-[24px]"
        >
  ...
  return (
    <Section className="bg-paper-raised">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <SectionTitle subtitle="Den borde inte äta din söndag.">
          Rättning tar tid.
          <br />
      ...
      <div className="mx-auto max-w-4xl px-6 text-center">
        ...
        <div className="mt-16">
          ...
          <p className="mx-auto mt-5 max-w-xl text-[16px] leading-relaxed text-ink-secondary">
            WiseOS tar det repetitiva. Du tar bedömningen.
          </p>
        </div>
      </div>
    </Section>
  ...
  const steps = [
    {
      n: "01",
      title: "Ladda upp",
      desc: "Provbunten — PDF eller bilder.",
    },
    {
      n: "02",
      title: "Förstå",
      desc: "Frågor och svar identifieras.",
    },
    {
      n: "03",
      title: "Bedöm",
      desc: "AI bedömer efter dina regler.",
    },
    {
      n: "04",
      title: "Granska",
      desc: "Du kontrollerar. Du godkänner.",
    },
  ];
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
            <div className="flex flex-col justify-center">
              ...
              <p className="mt-6 max-w-md text-[16px] leading-relaxed text-ink-secondary">
                AI bedömer. Du granskar innan du godkänner.
              </p>
              <div className="mt-8">
                <button
                  onClick={() => openAuth("access")}
...
function Control() {
  const features = [
    ...
    },
    {
      ...
      desc: "Kontrollerbar poängsättning.",
    },
    {
      title: "Originalet finns kvar",
      desc: "Alltid bredvid bedömningen.",
    },
    {
      title: "Du bestämmer",
      desc: "AI föreslår. Du beslutar.",
    },
  ];
    ...
    <Section>
      <div className="mx-auto max-w-4xl px-6 text-center">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-[16px] leading-relaxed text-ink-secondary">
          Handskrivna lösningar i matte, fysik och kemi — där bedömning tar längst tid.
        </p>
