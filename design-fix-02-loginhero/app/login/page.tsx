  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 md:flex md:min-h-screen md:items-center">
        <div className="max-w-xl pl-9 md:-translate-y-5">
          <motion.h1
            initial={{ opacity: 0, y: 20 }}
            animate={isInView ? { opacity: 1, y: 0 } : {}}
            transition={{ duration: 0.7, delay: 0.05, ease: [0.22, 1, 0.36, 1] }}
            className="mt-5 text-[38px] font-medium leading-[1.05] tracking-[-0.03em] text-ink md:text-[52px] lg:text-[60px]"
          >
            Rätta smartare.
          </motion.h1>
          ...
          <motion.p
            ...
            className="mt-4 text-[22px] font-light leading-[1.25] tracking-[-0.01em] text-ink-secondary md:text-[26px]"
          >
        ...
        <motion.p
          ...
          className="mt-14 pl-9 text-[12px] font-medium uppercase tracking-[0.14em] text-ink-muted md:absolute md:bottom-10 md:left-[60px] md:mt-0 md:pl-0"
        >
          {subjects.join(" · ")}
        </motion.p>
      </div>
      ...
      <motion.img
        ...
        src="/hero/bg-front-hero.jpg"
        alt="Laptop rakt framifrån som visar WiseOS översikt"
